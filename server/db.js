...
//TODO aby se ten bengr tam neinsertoal dvakrát
const tasks =  [
...
db.prepare('CREATE TABLE IF NOT EXISTS tasks (id INTEGER PRIMARY KEY, task TEXT NOT NULL, date DATE)').run();

const insert = db.prepare('INSERT INTO tasks (task, date) VALUES (@task, @date)');
